# Unreal C++ Course: Action Roguelike Game

Course project for the **[Professional Game Development in C++ and Unreal Engine](https://courses.tomlooman.com/p/unrealengine-cpp?coupon_code=COMMUNITY15&src=github)** course where we build an entire action roguelike game step-by-step.

Everything below has been copied directly from the instructor's [reference repository README](https://github.com/tomlooman/ActionRoguelike/blob/master/README.md).
